 ...
 */
public class ReadMessageTester {
    public static void main(String[] args) {
        ...
        //Producer producer = new NIOProducer(properties);
         ...
         //消费样例1，实际测试时会Kill掉发送进程，另取进程进行消费
         {
             ...
             System.out.println(String.format("Team1 cost:%d ms tps:%d q/ms", T2 , (queue1Offset + topic1Offset)/T2));
         ...
         //消费样例2，实际测试时会Kill掉发送进程，另取进程进行消费
         {
             ...
             long endConsumer = System.currentTimeMillis();
             long T2 = endConsumer - startConsumer;
             System.out.println(String.format("Team2 cost:%d ms tps:%d q/ms", T2, (queue2Offset + topic1Offset)/T2));
